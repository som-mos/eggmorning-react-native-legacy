...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#ffffff' : '#ffffff',
  ...
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#f7b500' : '#f7b500',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#fff' : '#fff',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#f7b500',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#f7b500',
  get statusBarColor() {
