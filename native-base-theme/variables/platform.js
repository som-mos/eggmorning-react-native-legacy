...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#f7b500' : '#fcdb00',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#fff' : '#161616',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#161616' : '#f7b500',
  tabBarTextSize: platform === PLATFORM.IOS ? 12 : 10,
  activeTab: platform === PLATFORM.IOS ? '#fff' : '#f7b500',
  sTabBarActiveTextColor: '#f7b500',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#f7b500',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#ffffff' : '#ffffff',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  ...
  // Icon
  iconFamily: 'Ionicons',
  iconFontSize: platform === PLATFORM.IOS ? 26 : 24,
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#f7b500' : '#3F51B5',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#3F51B5',
  segmentBorderColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#f7b500' : '#fff',
